...
# 10. Print the Quantum Circuit for Two Iterations as Text
print("\nQuantum Circuit for 2 Iterations:")
circuit_2_iterations = create_qaoa_circuit(*res.x, p=2)

# Print the circuit in a simple text format
print(circuit_2_iterations)
